...
/**
 * Patient transfer object representing the payload to create a new patient entry.
 *
 ...
 *
 * @param doctorId          the id of the doctor treating the patient; required field,
 ...
 *                          past dates allowed only; used for age calculations
 ...
 */
@Schema(description = "Data transfer object for new patient.")
public record CreatePatientRequest(
        @NotNull(message = "Doctor ID is required")
        @Positive(message = "Doctor ID must be a positive number")
        @Schema(description = "Id of the treating doctor", example = "A")
        Long doctorId,
