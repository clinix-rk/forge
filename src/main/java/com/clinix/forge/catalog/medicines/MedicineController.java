...
public class MedicineController {
    ...
    public ResponseEntity<ClinixApiResponse<MedicineResponse>> createMedicine(
    ...
    public ResponseEntity<ClinixApiResponse<List<MedicineResponse>>> getAllMedicines(
    ...
    public ResponseEntity<ClinixApiResponse<MedicineResponse>> getMedicineById(@PathVariable Long id) {
    ...
    public ResponseEntity<ClinixApiResponse<MedicineResponse>> updateMedicineById(
